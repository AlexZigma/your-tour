...
(() => {
  ...
  var init_html_mask_element = __esm({
    "node_modules/imask/esm/controls/html-mask-element.js"() {
      ...
      KEY_Z = 90;
      KEY_Y = 89;
      HTMLMaskElement = class extends MaskElement {
  ...
  var init_html_input_mask_element = __esm({
    "node_modules/imask/esm/controls/html-input-mask-element.js"() {
      ...
      init_holder();
      init_mask_element();
      HTMLInputMaskElement = class extends HTMLMaskElement {
  ...
  var init_html_contenteditable_mask_element = __esm({
    "node_modules/imask/esm/controls/html-contenteditable-mask-element.js"() {
      ...
      init_holder();
      init_mask_element();
      HTMLContenteditableMaskElement = class extends HTMLMaskElement {
  ...
  var init_chunk_tail_details = __esm({
    "node_modules/imask/esm/masked/pattern/chunk-tail-details.js"() {
      ...
      init_continuous_tail_details();
      init_holder();
      ChunksTailDetails = class _ChunksTailDetails {
        /** */
  ...
  var init_regexp = __esm({
    "node_modules/imask/esm/masked/regexp.js"() {
      ...
      init_continuous_tail_details();
      init_utils();
      MaskedRegExp = class extends Masked {
        /** */
        /** Enable characters overwriting */
        /** */
        /** */
  ...
  var init_pattern = __esm({
    "node_modules/imask/esm/masked/pattern.js"() {
      ...
      init_regexp();
      init_continuous_tail_details();
      MaskedPattern = class _MaskedPattern extends Masked {
        /** */
        /** */
  ...
  var init_range = __esm({
    "node_modules/imask/esm/masked/range.js"() {
      ...
      init_input_definition();
      init_regexp();
      MaskedRange = class extends MaskedPattern {
        /**
  ...
  var init_date = __esm({
    "node_modules/imask/esm/masked/date.js"() {
      ...
      init_input_definition();
      init_regexp();
      DefaultPattern = "d{.}`m{.}`Y";
      MaskedDate = class _MaskedDate extends MaskedPattern {
  ...
  var init_dynamic = __esm({
    "node_modules/imask/esm/masked/dynamic.js"() {
      ...
      init_holder();
      init_continuous_tail_details();
      MaskedDynamic = class _MaskedDynamic extends Masked {
        constructor(opts) {
          super({
  ...
  var init_enum = __esm({
    "node_modules/imask/esm/masked/enum.js"() {
      ...
      init_input_definition();
      init_regexp();
      MaskedEnum = class _MaskedEnum extends MaskedPattern {
        constructor(opts) {
          super({
  ...
  var init_function = __esm({
    "node_modules/imask/esm/masked/function.js"() {
      ...
      init_continuous_tail_details();
      init_utils();
      MaskedFunction = class extends Masked {
        /** */
        /** Enable characters overwriting */
        /** */
        /** */
  ...
  var init_number = __esm({
    "node_modules/imask/esm/masked/number.js"() {
      ...
      init_holder();
      init_continuous_tail_details();
      MaskedNumber = class _MaskedNumber2 extends Masked {
        /** Single char */
        /** Single char */
  ...
  var init_repeat = __esm({
    "node_modules/imask/esm/masked/repeat.js"() {
      ...
      init_input_definition();
      init_regexp();
      RepeatBlock = class extends MaskedPattern {
        get repeatFrom() {
          var _ref;
